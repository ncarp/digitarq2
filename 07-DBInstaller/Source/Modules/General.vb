...
#Region "Globaly assigned variables"
    ...
    Public EAD2CNF_XSLT_FILENAME As String = Application.StartupPath & "\xslt\" & "ead2cnf.xslt"
    Public EAC_XSLT_FILENAME As String = Application.StartupPath & "\xslt\" & "eac.xslt"
    Public STATECONFIG_FILENAME As String = Application.UserAppDataPath & "\" & "DigitArqState.config"
...
#Region "Configuration File APIs"
    ...
    Public Function Constant(ByVal key As String) As String
        Try
            Dim message As String = CType(ConfigurationSettings.GetConfig("constants"), Hashtable).Item(key)
            Return message
    ...
    Public Function LogMessage(ByVal key As String) As String
        Try
            Dim message As String = CType(ConfigurationSettings.GetConfig("logMessages"), Hashtable).Item(key)
            Return message
        Catch ex As Exception
            Return "Cannot Load Configuration File!"
        End Try
    ...
    Public Function ContextMenuLabel(ByVal key As String) As String
        Try
            Dim message As String = CType(ConfigurationSettings.GetConfig("contextMenu"), Hashtable).Item(key)
            Return message
        Catch ex As Exception
            Return "Cannot Load Configuration File!"
        End Try
