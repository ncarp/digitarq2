    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Me.Page.IsPostBack Then
            ...
            If Not objEmployee Is Nothing Then
                Me.lblMsg.Text = GetLabel("header.lblMsgUser")
                Me.lblUserName.Text = objEmployee.FirstName & " " & objEmployee.LastName
                Me.hlnkInitialPage.Text = GetLabel("header.lblChangeUser")
                Me.hlnkClose.Text = GetLabel("header.lblExit")
