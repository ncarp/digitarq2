<%@ Control Language="vb" AutoEventWireup="false" Codebehind="employees.ascx.vb" Inherits="GPU.employees" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table id="tblMain" cellSpacing="0" cellPadding="0" width="550" align="center" border="0">
	<tbody>
		...
		<tr>
			<td>
				<asp:Panel Runat="server" ID="pnlUsers"></asp:Panel>
			</td>
		</tr>
	</tbody>
</table>
