...
Public Class Employee
    ...
    Private myEmployeeExists As Boolean
...
#Region "Properties"
    ...
    Property Password() As String
        ...
        End Get
        Set(ByVal Value As String)
            myPassword = Encrypt.GenerateHash(Value)
        End Set
    End Property
    ...
    Property EmployeeExists() As Boolean
        Get
            Return myEmployeeExists
        End Get
        Set(ByVal Value As Boolean)
            myEmployeeExists = Value
        End Set
    End Property
