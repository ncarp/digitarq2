...
#Region "Properties definition"
    ...
    Public Const IncompleteDate As String = "^\d*-\d*-\d*$"
    Public Const DayMonthYear As String = "^\d\d-\d\d-\d\d\d\d$"
    Public Const YearMonthDay As String = "^\d\d\d\d-\d\d-\d\d$"
    Public Const YearMonth As String = "^\d\d\d\d-\d\d-$"
    Public Const YearDay As String = "^\d\d\d\d--\d\d$"
    Public Const Year As String = "^\d\d\d\d--$"
    Public Const JustYear As String = "^\d\d\d\d$"
...
#Region "General Shared Functions"
    ...
    Public Shared Function IsValidDate(ByVal v As String) As Boolean
        ...
        'Return Matches(v, "^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]$")
    End Function
