...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FindResultsForm))
        ...
        'Panel2
        '
        Me.Panel2.Controls.Add(Me.lblResultsCount)
        ...
        'lblResultsCount
        '
        Me.lblResultsCount.Location = New System.Drawing.Point(16, 8)
        Me.lblResultsCount.Name = "lblResultsCount"
        Me.lblResultsCount.Size = New System.Drawing.Size(216, 25)
        Me.lblResultsCount.TabIndex = 4
        Me.lblResultsCount.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'btnGoto
        '
        ...
        Me.btnGoto.Location = New System.Drawing.Point(254, 8)
        ...
        Me.Panel1.Size = New System.Drawing.Size(418, 295)
        Me.Panel1.TabIndex = 5
        '
        'ListView
        '
        Me.ListView.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.ListView.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.chOtherLevel, Me.chUnitId, Me.chUnitTitle, Me.chID})
        ...
        Me.ListView.Size = New System.Drawing.Size(418, 295)
        ...
        Me.chUnitId.Width = 103
        '
        'chUnitTitle
        '
        Me.chUnitTitle.Text = "Título"
        Me.chUnitTitle.Width = 269
        '
        'chID
        '
        Me.chID.Text = "ID"
...
#End Region
    ...
    Private myLazyNodes As LazyNodeCollection
    Private myLazyTree As LazyTree

    Public Sub New(ByVal LazyNodes As LazyNodeCollection, ByVal LazyTree As LazyTree)
        Me.New()
        myLazyNodes = LazyNodes
        myLazyTree = LazyTree
    End Sub
    ...
    Private Sub LoadResultsList()
        ...
        For Each LazyNode In myLazyNodes
            Dim Row As New ListViewItem("", LazyNode.OtherLevelIndex)
            Row.UseItemStyleForSubItems = False
            Dim Icon As New ListViewItem.ListViewSubItem(Row, "")
            Dim UnitId As New ListViewItem.ListViewSubItem(Row, LazyNode.UnitId)
            Dim UnitTitle As New ListViewItem.ListViewSubItem(Row, LazyNode.UnitTitle)
            Dim ID As New ListViewItem.ListViewSubItem(Row, IntToStr(LazyNode.ID))
        ...
        Next
        Me.lblResultsCount.Text = String.Format(InfoMessage("FindResults.ResultsCount"), ListView.Items.Count)
    End Sub
    ...
    Private Sub btnGoto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGoto.Click
        ...
        myLazyTree.SelectedLazyNode = myLazyNodes.FetchLazyNodeByID(StrToInt(ListView.SelectedItems.Item(0).SubItems(3).Text))
    End Sub
