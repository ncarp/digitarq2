...
Public Class VisualFieldArrangement
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("Arrangement"), VisualTextField.TextBoxWidthExtraLarge, VisualTextField.TextBoxHeightMediumSmall)
        myTextField.Value = LazyNode.Arrangement
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.Arrangement = CStr(Value)
