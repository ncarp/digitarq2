...
Public Class VisualFieldAcqInfo
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("AcqInfo"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.AcqInfo
