...
Public Class VisualFieldAccruals
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("Accruals"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.Accruals
