...
Public Class VisualFieldFilePlan
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("FilePlan"), VisualTextField.TextBoxWidthExtraLarge, VisualTextField.TextBoxHeightMediumSmall)
        myTextField.Value = LazyNode.FilePlan
