...
Public Class VisualFieldRelatedMaterial
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("RelatedMaterial"), VisualTextField.TextBoxWidthExtraLarge - 15, VisualTextField.TextBoxHeightMediumSmall)
        myTextField.Value = LazyNode.RelatedMaterial
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.RelatedMaterial = CStr(Value)
