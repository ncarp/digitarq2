...
Public Class VisualFieldOtherFindAid
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("OtherFindAid"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.OtherFindAid
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.OtherFindAid = CStr(Value)
