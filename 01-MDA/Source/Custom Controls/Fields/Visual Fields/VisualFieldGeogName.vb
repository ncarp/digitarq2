...
Public Class VisualFieldGeogName
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("GeogName"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.GeogName
