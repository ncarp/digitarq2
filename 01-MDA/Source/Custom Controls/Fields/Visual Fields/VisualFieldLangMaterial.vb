...
Public Class VisualFieldLangMaterial
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("LangMaterial"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Mandatory = True
        myTextField.Value = LazyNode.LangMaterial
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.LangMaterial = CStr(Value)
