...
Public Class VisualFieldRepository
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("Repository"), VisualTextField.TextBoxWidthLarge)
        myTextField.Mandatory = True
        myTextField.Value = LazyNode.Repository
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.Repository = CStr(Value)
