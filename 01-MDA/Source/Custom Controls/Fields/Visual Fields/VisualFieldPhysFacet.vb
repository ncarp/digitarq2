...
Public Class VisualFieldPhysFacet
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("PhysFacet"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.PhysFacet
