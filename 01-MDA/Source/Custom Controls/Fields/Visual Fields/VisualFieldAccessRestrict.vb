...
Public Class VisualFieldAccessRestrict
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("AccessRestrict"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.AccessRestrict
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.AccessRestrict = CStr(Value)
