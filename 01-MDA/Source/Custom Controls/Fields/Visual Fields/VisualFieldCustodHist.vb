...
Public Class VisualFieldCustodHist
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("CustodHist"), VisualTextField.TextBoxWidthExtraLarge, VisualTextField.TextBoxHeightMedium)
        myTextField.Value = LazyNode.CustodHist
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.CustodHist = CStr(Value)
