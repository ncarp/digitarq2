...
Public Class VisualFieldLegalStatus
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("LegalStatus"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.LegalStatus
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.LegalStatus = CStr(Value)
