...
Public Class VisualFieldBiogHist
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("BiogHist"), VisualTextField.TextBoxWidthExtraLarge, VisualTextField.TextBoxHeightMedium)
        myTextField.Mandatory = True
        myTextField.Value = LazyNode.BiogHist
