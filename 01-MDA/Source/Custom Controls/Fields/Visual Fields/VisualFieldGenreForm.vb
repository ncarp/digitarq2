...
Public Class VisualFieldGenreForm
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("GenreForm"), VisualTextField.TextBoxWidthLarge)
        myTextField.Value = LazyNode.GenreForm
