...
Public Class VisualFieldNote
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("Note"), VisualTextField.TextBoxWidthExtraLarge, VisualTextField.TextBoxHeightMedium)
        myTextField.Value = LazyNode.Note
