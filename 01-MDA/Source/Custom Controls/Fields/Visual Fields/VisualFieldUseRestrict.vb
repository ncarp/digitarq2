...
Public Class VisualFieldUseRestrict
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("UseRestrict"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.UseRestrict
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.UseRestrict = CStr(Value)
