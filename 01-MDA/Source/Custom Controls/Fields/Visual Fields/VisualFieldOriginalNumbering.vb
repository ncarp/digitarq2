...
Public Class VisualFieldOriginalNumbering
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("OriginalNumbering"), VisualTextField.TextBoxWidthMedium)
        myTextField.Value = LazyNode.OriginalNumbering
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.OriginalNumbering = CStr(Value)
