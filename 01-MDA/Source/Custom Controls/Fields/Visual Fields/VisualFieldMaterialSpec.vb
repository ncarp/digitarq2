...
Public Class VisualFieldMaterialSpec
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("MaterialSpec"), VisualTextField.TextBoxWidthExtraLarge)
        myTextField.Value = LazyNode.MaterialSpec
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.MaterialSpec = CStr(Value)
