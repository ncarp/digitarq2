...
Public Class VisualFieldPreferCite
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("PreferCite"), VisualTextField.TextBoxWidthMedium)
        myTextField.Value = CStr(LazyNode.PreferCite)
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.PreferCite = CStr(Value)
