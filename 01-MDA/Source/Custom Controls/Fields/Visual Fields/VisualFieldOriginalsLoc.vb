...
Public Class VisualFieldOriginalsLoc
    ...
    Public Sub New(ByVal LazyNode As LazyNode)
        ...
        myTextField = New VisualTextField(VisualFieldLabel("OriginalsLoc"), VisualTextField.TextBoxWidthExtraLarge - 15)
        myTextField.Value = LazyNode.OriginalsLoc
    ...
    Private Sub Upload(ByVal EventCode As Integer, ByVal Value As Object) Handles myTextField.ValueChanged
        LazyNode.OriginalsLoc = CStr(Value)
