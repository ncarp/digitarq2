...
Public Class SeriesListReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MDA.SeriesListReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSeriesListReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SeriesListReport = New SeriesListReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
