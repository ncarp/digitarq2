...
Public Class FondsGuideReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MDA.FondsGuideReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFondsGuideReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FondsGuideReport = New FondsGuideReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
