...
Public Class GeneUIInventory
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        If obj.OtherLevel = OTHERLEVEL_FONDS OrElse _
        obj.OtherLevel = OTHERLEVEL_SUBFONDS OrElse _
        obj.OtherLevel = OTHERLEVEL_SECTION OrElse _
        obj.OtherLevel = OTHERLEVEL_SUBSECTION OrElse _
        obj.OtherLevel = OTHERLEVEL_SUBSUBSECTION OrElse _
        obj.OtherLevel = OTHERLEVEL_SERIES OrElse _
        obj.OtherLevel = OTHERLEVEL_SUBSERIES OrElse _
        obj.OtherLevel = OTHERLEVEL_INSTALATIONUNIT _
        Then
            Result.Insert(0, obj)
        End If
