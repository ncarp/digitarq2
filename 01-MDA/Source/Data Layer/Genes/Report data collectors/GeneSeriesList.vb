...
Public Class GeneSeriesList
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        ChildSeries = GetChildSeries(obj)

        For Each Series As LazyNode In ChildSeries
            Result = AppendToHashtable(Result, Series, obj)
        Next
    ...
    Private Function GetChildSeries(ByVal Node As LazyNode) As LazyNodeCollection
        Dim ChildNode As LazyNode
        Dim Result As New LazyNodeCollection

        For Each ChildNode In Node.Children
            If ChildNode.OtherLevel = EADDefinitions.OTHERLEVEL_SERIES OrElse _
               ChildNode.OtherLevel = EADDefinitions.OTHERLEVEL_SUBSERIES Then
