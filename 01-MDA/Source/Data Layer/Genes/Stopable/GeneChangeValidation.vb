...
Public Class GeneChangeValidation
    ...
    Public Sub New(ByVal Valid As Boolean, ByVal ProgressDialog As ProgressDialog)
        myValid = Valid
        myProgressDialog = ProgressDialog
    End Sub

    Public Sub New(ByVal Valid As Boolean)
        myValid = Valid
    End Sub
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        If Not myProgressDialog Is Nothing Then
            myProgressDialog.Message = String.Format(InfoMessage("ChangeValidation.Progression"), obj.UnitId)
