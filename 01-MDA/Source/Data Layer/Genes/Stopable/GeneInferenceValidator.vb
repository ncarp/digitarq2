...
Public Class GeneInferenceValidator
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        Result = Validator.GetLazyNodeInferenceErrors(obj)
        ...
        If Not myProgressDialog Is Nothing Then
            myProgressDialog.Message = String.Format(InfoMessage("Validator.Progression"), obj.UnitId)
