...
Public Class GeneErasor
    ...
    Public Sub New(ByVal ProgressDialog As ProgressDialog, ByVal ServerAddress As String, ByVal Database As String, _
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        SQLLazyNode.RemoveNode(myServerAddress, myDatabase, myUsername, myPassword, obj.ID)

        If Not myProgressDialog Is Nothing Then
            myProgressDialog.Message = String.Format(InfoMessage("Erasor.Progression"), obj.UnitId)
