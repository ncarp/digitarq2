...
Public Class GeneNodeCounterPro
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        result(obj.OtherLevel) = 1
        For Each childResult In ChildrenResults
            result = AddResults(result, childResult)
        Next
        Return result
    End Function


    Public Shared Function AddResults(ByVal h1 As Hashtable, ByVal h2 As Hashtable) As Hashtable
        For Each key As Object In h1.Keys
            If h2.ContainsKey(key) Then
                h2.Item(key) = h2.Item(key) + h1.Item(key)
            Else
                h2.Item(key) = h1.Item(key)
            End If
        Next
        Return h2
    End Function
