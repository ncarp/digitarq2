...
Public Class GeneChangeVisiblility
    ...
    Public Sub New(ByVal Visible As Boolean, ByVal ProgressDialog As ProgressDialog)
        myVisible = Visible
    ...
    Public Overrides Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Microsoft.VisualBasic.Collection) As Object
        ...
        'If obj.Valid Then
        '    obj.Visible = myVisible
        '    obj.Upload()
        'End If

        ' Changed in new version
        ' Now we can change visibility without testing validity
        obj.Visible = myVisible
        obj.Upload()
        ...
        If Not myProgressDialog Is Nothing Then
            myProgressDialog.Message = String.Format(InfoMessage("ChangeVisibility.Progression"), obj.UnitId)
