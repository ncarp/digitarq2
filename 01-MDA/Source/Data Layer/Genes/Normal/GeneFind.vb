...
Public Class GeneFind
    ...
    Public Function Apply(ByVal obj As LazyNode, ByVal ChildrenResults As Collection) As Object Implements Gene.Apply
        Dim Result As New LazyNodeCollection

        If myUnitId.Length = 0 And _
           myUnitTitle.Length = 0 And _
           myUnitDateInitial.Length = 0 And _
           myUnitDateFinal.Length = 0 _
           Then
            Return Result
        End If
