...
#Region "Globaly assigned variables"
    ...
    Public STATECONFIG_FILENAME As String = Application.UserAppDataPath & "\" & "MDA.config"
    ...
    Public USER_LOGON As String
    Public ADMIN_USERNAME As String = "admin"
    Public ADMIN_PASSWORD As String = "admin"
