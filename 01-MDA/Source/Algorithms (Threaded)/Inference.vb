...
#Region "Inference Algorithms"
    ...
    Public Sub Infer()
        ...
        myProgressDialog.Text = String.Format(InfoMessage("Inference.Title"), myRootLazyNode.UnitTitle)
        '"A importar " & Path.GetFileName(myFilename) & "..."
        myProgressDialog.Show()


        Dim t As Thread = New Thread(New ThreadStart(AddressOf InfereLazyNode))
        t.Start()
    ...
    Private Sub InfereLazyNode()
        myRootLazyNode.StopableCatamorphism(New GeneInference(myProgressDialog))
    End Sub
