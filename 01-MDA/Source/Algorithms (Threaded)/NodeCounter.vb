...
#Region "Algorithms"
    ...
    Private myNumberOfNodes As Integer = Nothing
    ...
    Public Sub CountNodes()
        ...
        Dim t As Thread = New Thread(New ThreadStart(AddressOf NodeCounter))
        t.Start()
    ...
    Private Sub ShowNumberOfNodes()
        If myNumberOfNodes = Nothing Then Exit Sub
        MsgBox(String.Format(InfoMessage("Statistics.NodeCount"), myNumberOfNodes), MsgBoxStyle.Information)
    End Sub




    Private Sub NodeCounter()
        myNumberOfNodes = myRootLazyNode.StopableCatamorphism(New GeneNodeCounter(myProgressDialog))
    End Sub
