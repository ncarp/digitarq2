...
Public Class ValidationErrorCollection
    ...
    Default Public Property Item(ByVal index As Integer) As ValidationError
        Get
            Return CType(List(index), ValidationError)
        End Get
    ...
    Public Function Add(ByVal value As ValidationErrorCollection) As Integer
    ...
    Public Function IndexOf(ByVal value As ValidationError) As Integer
    ...
    Public Sub Remove(ByVal value As ValidationError)
        List.Remove(value)
    End Sub 'Remove


    Public Function Contains(ByVal value As ValidationError) As Boolean
