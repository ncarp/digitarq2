...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents lbxLampTypes As System.Windows.Forms.ListBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(LampTypeForm))
        ...
        Me.lbxLampTypes = New System.Windows.Forms.ListBox
        ...
        Me.gbxLampTypes.Controls.Add(Me.lbxLampTypes)
        ...
        'lbxLampTypes
        '
        Me.lbxLampTypes.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lbxLampTypes.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.lbxLampTypes.Location = New System.Drawing.Point(13, 21)
        Me.lbxLampTypes.Name = "lbxLampTypes"
        Me.lbxLampTypes.Size = New System.Drawing.Size(199, 210)
        Me.lbxLampTypes.TabIndex = 10
        '
        'LampTypeForm
        '
        ...
        Me.Name = "LampTypeForm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = CType(configurationAppSettings.GetValue("LT.Text", GetType(System.String)), String)
...
#Region "LampTypeForm"
    ...
    Private Sub LampTypeForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadData()
        DisableEdition()
    End Sub

    Private Sub LampTypeForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
#Region "New/Edit/Save"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        If btnEdit.Text.Equals(configReader.GetValue("btnEdit.Text", GetType(String))) Then
            If Not Me.lbxLampTypes.SelectedItem Is Nothing Then
                EnableEdition()
                Me.txtNew.Text = Me.lbxLampTypes.SelectedItem.Description
                Me.txtNew.Focus()
            ...
            Select Case Me.btnEdit.Tag
                Case "Update"
                    If Me.txtNew.Text.Trim <> "" Then
                        Dim res As Boolean = database.UpdateLampType(lbxLampTypes.SelectedItem.LampTypeID, Me.txtNew.Text)
                        If res Then
                            Log.Append(Constants.UserLogon, Log.EditNode, "Lamp type " & lbxLampTypes.SelectedItem.Description & " was edited.")
                            LoadData()
                        End If
                    End If
                Case "New"
                    If Me.txtNew.Text.Trim <> "" Then
                        Dim res As Boolean = database.InsertLampType(Me.txtNew.Text)
                        If res Then
                            Log.Append(Constants.UserLogon, Log.AppendNode, "New lamp type was added to database.")
                            LoadData()
                        End If
                    End If
            End Select
...
#Region "Delete"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If MsgBox(InfoMessage("LampType.DeleteLampType") & Me.lbxLampTypes.GetItemText(Me.lbxLampTypes.SelectedItem) & "' da base de dados?", MsgBoxStyle.YesNo, InfoMessage("LampType.Title")) = MsgBoxResult.Yes Then
            Log.Append(Constants.UserLogon, Log.RemoveNode, "Lamp type " & lbxLampTypes.SelectedItem.Description & " was deleted from database.")
            res = database.DeleteLampType(lbxLampTypes.SelectedItem.LampTypeID)
            If res Then
                LoadData()
            End If
        End If
...
#Region "Load Data"
    ...
    Private Sub LoadData()
        ...
        lbxLampTypes.Items.Clear()

        For Each myLampType As LampType In mydata
            lbxLampTypes.Items.Add(New LampType(myLampType.Description, myLampType.LampTypeID))
        Next
    End Sub
