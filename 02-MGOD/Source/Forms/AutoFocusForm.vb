...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents lbxAutoFocus As System.Windows.Forms.ListBox
    Friend WithEvents btnNew As System.Windows.Forms.Button
    Friend WithEvents imglButtons As System.Windows.Forms.ImageList
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Dim configurationAppSettings As System.Configuration.AppSettingsReader = New System.Configuration.AppSettingsReader
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(AutoFocusForm))
        ...
        Me.lbxAutoFocus = New System.Windows.Forms.ListBox
        ...
        Me.gbxLampTypes.Controls.Add(Me.lbxAutoFocus)
        ...
        'lbxAutoFocus
        '
        Me.lbxAutoFocus.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lbxAutoFocus.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.lbxAutoFocus.Location = New System.Drawing.Point(13, 21)
        Me.lbxAutoFocus.Name = "lbxAutoFocus"
        Me.lbxAutoFocus.Size = New System.Drawing.Size(199, 210)
        Me.lbxAutoFocus.TabIndex = 10
        '
        'btnNew
        '
        ...
        Me.Name = "AutoFocusForm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = CType(configurationAppSettings.GetValue("AF.Text", GetType(System.String)), String)
...
#Region "AutoFocusForm"

    Private Sub AutoFocusForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadData()
        DisableEdition()
    End Sub

    Private Sub AutoFocusForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
#Region "New/Edit/Save"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        If btnEdit.Text.Equals(configReader.GetValue("btnEdit.Text", GetType(String))) Then
            If Not Me.lbxAutoFocus.SelectedItem Is Nothing Then
                EnableEdition()
                Me.txtNew.Text = Me.lbxAutoFocus.SelectedItem.Description
                Me.txtNew.Focus()
            ...
            Select Case Me.btnEdit.Tag
                Case "Update"
                    If Me.txtNew.Text.Trim <> "" Then
                        Dim res As Boolean = database.UpdateAutoFocus(lbxAutoFocus.SelectedItem.AutoFocusID, Me.txtNew.Text)
                        If res Then
                            Log.Append(Constants.UserLogon, Log.EditNode, "Auto focus " & Me.lbxAutoFocus.SelectedItem.Description & " was edited.")
                            LoadData()
                        End If
                    End If
                Case "New"
                    If Me.txtNew.Text.Trim <> "" Then
                        Dim res As Boolean = database.InsertAutoFocus(Me.txtNew.Text)
                        If res Then
                            Log.Append(Constants.UserLogon, Log.AppendNode, "New auto focus was added to database.")
                            LoadData()
                        End If
                    End If
            End Select
...
#Region "Delete"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If MsgBox(InfoMessage("AutoFocus.DeleteAutoFocus") & Me.lbxAutoFocus.GetItemText(Me.lbxAutoFocus.SelectedItem) & "' da base de dados?", MsgBoxStyle.YesNo, InfoMessage("AutoFocus.Title")) = MsgBoxResult.Yes Then
            Log.Append(Constants.UserLogon, Log.RemoveNode, "Auto focus " & Me.lbxAutoFocus.SelectedItem.Description & " was deleted from database.")
            res = database.DeleteAutoFocus(Me.lbxAutoFocus.SelectedItem.AutoFocusID)
            If res Then
                LoadData()
            End If
        End If
...
#Region "Load Data"
    ...
    Private Sub LoadData()
        ...
        Me.lbxAutoFocus.Items.Clear()

        For Each myAutoFocus As AutoFocus In mydata
            Me.lbxAutoFocus.Items.Add(New AutoFocus(myAutoFocus.Description, myAutoFocus.AutoFocusID))
        Next
    End Sub
