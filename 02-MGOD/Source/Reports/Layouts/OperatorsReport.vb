...
Public Class OperatorsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MGOD.OperatorsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOperatorsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OperatorsReport = New OperatorsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
