...
Public Class MIDOFilesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MGOD.MIDOFilesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMIDOFilesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MIDOFilesReport = New MIDOFilesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
